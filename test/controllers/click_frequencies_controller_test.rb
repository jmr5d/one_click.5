...
class ClickFrequenciesControllerTest < ActionController::TestCase
  ...
  test "should create click_frequency" do
    assert_difference('ClickFrequency.count') do
      post :create, click_frequency: { count: @click_frequency.count, measure_name_id: @click_frequency.measure_name_id, user_id: @click_frequency.user_id }
    end
  ...
  test "should update click_frequency" do
    patch :update, id: @click_frequency, click_frequency: { count: @click_frequency.count, measure_name_id: @click_frequency.measure_name_id, user_id: @click_frequency.user_id }
    assert_redirected_to click_frequency_path(assigns(:click_frequency))
  end

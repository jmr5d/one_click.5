...
class MeasureUnitsControllerTest < ActionController::TestCase
  ...
  test "should create measure_unit" do
    assert_difference('MeasureUnit.count') do
      post :create, measure_unit: { abbreviation: @measure_unit.abbreviation, measurement_id: @measure_unit.measurement_id, name: @measure_unit.name }
    end
  ...
  test "should update measure_unit" do
    patch :update, id: @measure_unit, measure_unit: { abbreviation: @measure_unit.abbreviation, measurement_id: @measure_unit.measurement_id, name: @measure_unit.name }
    assert_redirected_to measure_unit_path(assigns(:measure_unit))
  end

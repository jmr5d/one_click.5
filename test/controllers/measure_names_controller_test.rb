...
class MeasureNamesControllerTest < ActionController::TestCase
  ...
  test "should create measure_name" do
    assert_difference('MeasureName.count') do
      post :create, measure_name: { measurement_id: @measure_name.measurement_id, name: @measure_name.name, position: @measure_name.position }
    end
  ...
  test "should update measure_name" do
    patch :update, id: @measure_name, measure_name: { measurement_id: @measure_name.measurement_id, name: @measure_name.name, position: @measure_name.position }
    assert_redirected_to measure_name_path(assigns(:measure_name))
  end
